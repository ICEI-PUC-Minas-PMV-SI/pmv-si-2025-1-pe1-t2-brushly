...
| RF04   | O sistema deve validar se o arquivo enviado é uma imagem.                 | A Definir                   |  |
| RF05   | O sistema deve fazer a edição da imagem(com as funcionalidades apresentadas).                 | A Definir                   | |
